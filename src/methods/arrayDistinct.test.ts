...
describe("arrayDistinct", () => {
    ...
    it("should handle arrays with objects", () => {
        ...
        expect(arrayDistinct([{ id: 1 }], [{ id: 1 }])).toEqual([{ id: 1 }, { id: 1 }]);
    });

    it("should handle arrays with null and undefined values", () => {
        expect(arrayDistinct([null, undefined, 1], [1, 2, 3])).toEqual([null, undefined, 2, 3]);
        expect(arrayDistinct([1, 2, 3], [undefined, null, 3])).toEqual([1, 2, undefined, null]);
    });
    ...
    it("should handle arrays with mixed types", () => {
        expect(arrayDistinct([1, "a", true], ["a", false, 2])).toEqual([1, true, false, 2]);
    });
