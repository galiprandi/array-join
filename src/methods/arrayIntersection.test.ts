...
describe.only("arrayDifference", () => {
    ...
    it("should handle different data types", () => {
        expect(arrayDifference([1, "2", true, false], ["2", false])).toEqual([1, true]);
    });

    it("should handle undefined and null values", () => {
        expect(arrayDifference([1, undefined, null, 2], [undefined])).toEqual([1, null, 2]);
    });
    ...
    it("should throw an error if the first argument is not an array", () => {
        expect(() => arrayDifference("not array" as any, [1, 2])).toThrow("Both arguments must be arrays");
    });

    it("should throw an error if the second argument is not an array", () => {
        expect(() => arrayDifference([1, 2, 3], "not array" as any)).toThrow("Both arguments must be arrays");
    });
});
