...
describe("arrayTruthy", () => {
    ...
    it("should throw an error if input is not an array", () => {
        ...
        expect(() => arrayTruthy(undefined as any)).toThrow("Input must be an array");
        expect(() => arrayTruthy("not an array" as any)).toThrow("Input must be an array");
    ...
    it("should remove only falsy values and leave all truthy values intact", () => {
        ...
        const input = [false, 0, "", null, undefined, NaN, "0", 0.1, truthyArr, truthyObj, true];
